...
abstract class OuvrageGen extends ConceptEntity<Ouvrage> { 
  ...
  OuvrageGen.withId(Concept concept, String idOuvrage) : super.of(concept) { 
  ...
  String get idOuvrage => getAttribute("idOuvrage"); 
  set idOuvrage(String a) => setAttribute("idOuvrage", a); 
